...
TEST_F(SpmdPartitioningTest, Crashing) {

  absl::string_view hlo_string = R"(

HloModule pjit__unnamed_wrapped_function_, entry_computation_layout={(f32[2,32,128]{2,1,0}, f32[2,128]{1,0}, f32[128]{0})->f32[]}, allow_spmd_sharding_propagation_to_output={true}

%region_0.25 (Arg_0.26: f32[], Arg_1.27: f32[]) -> f32[] {
  %Arg_0.26 = f32[] parameter(0)
  %Arg_1.27 = f32[] parameter(1)
  ROOT %add.28 = f32[] add(f32[] %Arg_0.26, f32[] %Arg_1.27), metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/reduce_sum[axes=(0, 1, 2)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
}

%region_1.31 (Arg_0.32: f32[], Arg_1.33: f32[]) -> f32[] {
  %Arg_0.32 = f32[] parameter(0)
  %Arg_1.33 = f32[] parameter(1)
  ROOT %add.34 = f32[] add(f32[] %Arg_0.32, f32[] %Arg_1.33), metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/reduce_sum[axes=(0,)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
}

ENTRY %main.38 (Arg_0.1: f32[2,32,128], Arg_1.2: f32[2,128], Arg_2.3: f32[128]) -> f32[] {
  %Arg_0.1 = f32[2,32,128]{2,1,0} parameter(0), sharding={devices=[2,1,1,4]0,1,2,3,4,5,6,7 last_tile_dim_replicate}
  %copy.5 = f32[2,32,128]{2,1,0} copy(f32[2,32,128]{2,1,0} %Arg_0.1), sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/full_to_shard[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}
  %custom-call.8 = f32[2,32,128]{2,1,0} custom-call(f32[2,32,128]{2,1,0} %copy.5), custom_call_target="SPMDFullToShardShape", sharding={manual}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/full_to_shard[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}, backend_config="unspecified_dims=[0,1,2]"
  %copy.4 = f32[2,32,128]{2,1,0} copy(f32[2,32,128]{2,1,0} %custom-call.8), sharding={devices=[2,1,1,4]0,1,2,3,4,5,6,7 last_tile_dim_replicate}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/full_to_shard[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %custom-call.12 = f32[1,32,128]{2,1,0} custom-call(f32[2,32,128]{2,1,0} %copy.4), custom_call_target="SPMDFullToShardShape", sharding={devices=[1,1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/full_to_shard[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}, backend_config="unspecified_dims=[1,2]"
  %reshape.15 = f32[32,128]{1,0} reshape(f32[1,32,128]{2,1,0} %custom-call.12), sharding={devices=[1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/squeeze[dimensions=(0,)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %Arg_1.2 = f32[2,128]{1,0} parameter(1), sharding={devices=[2,1,4]0,1,2,3,4,5,6,7 last_tile_dim_replicate}
  %copy.3 = f32[2,128]{1,0} copy(f32[2,128]{1,0} %Arg_1.2), sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/full_to_shard[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}
  %custom-call.10 = f32[2,128]{1,0} custom-call(f32[2,128]{1,0} %copy.3), custom_call_target="SPMDFullToShardShape", sharding={manual}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/full_to_shard[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}, backend_config="unspecified_dims=[0,1]"
  %copy.2 = f32[2,128]{1,0} copy(f32[2,128]{1,0} %custom-call.10), sharding={devices=[2,1,4]0,1,2,3,4,5,6,7 last_tile_dim_replicate}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/full_to_shard[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %custom-call.14 = f32[1,128]{1,0} custom-call(f32[2,128]{1,0} %copy.2), custom_call_target="SPMDFullToShardShape", sharding={devices=[1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/full_to_shard[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}, backend_config="unspecified_dims=[1]"
  %reshape.16 = f32[128]{0} reshape(f32[1,128]{1,0} %custom-call.14), sharding={devices=[1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/squeeze[dimensions=(0,)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %custom-call.17 = (f32[32,128]{1,0}, f32[32]{0}) custom-call(f32[32,128]{1,0} %reshape.15, f32[128]{0} %reshape.16), custom_call_target="fake_custom_call_fwd", operand_layout_constraints={f32[32,128]{1,0}, f32[128]{0}}, api_version=API_VERSION_STATUS_RETURNING, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/fake_custom_call_fwd[mesh=None epsilon=1e-05]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}, backend_config=" \000\000\000\000\000\000\000\200\000\000\000\000\000\000\000\254\305\'7\271U\000\000"
  %get-tuple-element.19 = f32[32]{0} get-tuple-element((f32[32,128]{1,0}, f32[32]{0}) %custom-call.17), index=1, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/fake_custom_call_fwd[mesh=None epsilon=1e-05]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %get-tuple-element.18 = f32[32,128]{1,0} get-tuple-element((f32[32,128]{1,0}, f32[32]{0}) %custom-call.17), index=0, sharding={devices=[1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/fake_custom_call_fwd[mesh=None epsilon=1e-05]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %reshape.20 = f32[1,32,128]{2,1,0} reshape(f32[32,128]{1,0} %get-tuple-element.18), sharding={devices=[1,1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/broadcast_in_dim[shape=(1, 32, 128) broadcast_dimensions=(1, 2)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %copy.1 = f32[1,32,128]{2,1,0} copy(f32[1,32,128]{2,1,0} %reshape.20), sharding={devices=[1,1,1,2,4]0,1,2,3,4,5,6,7 last_tile_dims={manual, replicated}}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/shard_to_full[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}
  %custom-call.22 = f32[2,32,128]{2,1,0} custom-call(f32[1,32,128]{2,1,0} %copy.1), custom_call_target="SPMDShardToFullShape", sharding={devices=[2,1,1,4]0,1,2,3,4,5,6,7 last_tile_dim_replicate}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/vmap(vmap(xmap(<unnamed function>)))/shard_to_full[axes=OrderedDict([(\'pp\', 0)]) mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\',)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=103}, backend_config="unspecified_dims=[1,2]"
  %copy = f32[2,32,128]{2,1,0} copy(f32[2,32,128]{2,1,0} %custom-call.22), sharding={manual}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/shard_to_full[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}
  %custom-call.24 = f32[2,32,128]{2,1,0} custom-call(f32[2,32,128]{2,1,0} %copy), custom_call_target="SPMDShardToFullShape", sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/vmap(xmap(<lambda>))/shard_to_full[axes=OrderedDict() mesh=Mesh(device_ids=array([[0, 1, 2, 3],\n       [4, 5, 6, 7]]), axis_names=(\'pp\', \'tp\')) manual_axes=(\'pp\', \'tp\')]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=145}, backend_config="unspecified_dims=[0,1,2]"
  %constant.6 = f32[] constant(0)
  %reduce.29 = f32[] reduce(f32[2,32,128]{2,1,0} %custom-call.24, f32[] %constant.6), dimensions={0,1,2}, to_apply=%region_0.25, sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/reduce_sum[axes=(0, 1, 2)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
  %constant.5 = f32[] constant(8192), sharding={replicated}
  %divide.30 = f32[] divide(f32[] %reduce.29, f32[] %constant.5), sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/div" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
  %Arg_2.3 = f32[128]{0} parameter(2), sharding={devices=[4,2]0,4,1,5,2,6,3,7 last_tile_dim_replicate}
  %reduce.35 = f32[] reduce(f32[128]{0} %Arg_2.3, f32[] %constant.6), dimensions={0}, to_apply=%region_1.31, sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/reduce_sum[axes=(0,)]" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
  %constant.4 = f32[] constant(128), sharding={replicated}
  %divide.36 = f32[] divide(f32[] %reduce.35, f32[] %constant.4), sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/div" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
  ROOT %add.37 = f32[] add(f32[] %divide.30, f32[] %divide.36), sharding={replicated}, metadata={op_name="pjit(<unnamed wrapped function>)/jit(main)/add" source_file="/home/mamini/projects/vmap_xmap_custom_vmap_issue/delay_xmap_lowering_tiny_repro.py" source_line=188}
}
)";
